    ...
    return (
      <center>
        <div>
          ...
          <p>
            PLEASE READ THIS TERMS OF CONDITIONS AGREEMENT CAREFULLY. BY USING
            THIS WEBSITE OR USING SERVICES FROM THIS WEBSITE YOU AGREE TO BE
            BOUND BY ALL OF THE TERMS AND CONDITIONS OF THIS AGREEMENT.
          </p>
          <p>
            {" "}
            These terms and conditions outline the rules and regulations for the
            use of Hiremedy’s Website. By accessing this website we assume you
            accept these terms and conditions in full. Do not continue to use
            Hiremedy’s website if you do not accept all of the terms and
